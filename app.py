...
Sebenrnya udah benar dan sangat bagus tpi ada sedikit revisi 
1. Untuk setiap kondisi, itu terdapat 3 hari deadline dan warnanya merah, kuning, atayu hijau disetiap status.
2. Untuk table nanti akan menambahkan from date hingga deadline dimana setiap yang periodical itu dimulai dari tanggal 1th
3. Untuk setiap yang incidental akan dibutuhkan 1 kolom tambahan yaitu from date (Tanggal dimana dia menerima email)
